...
export declare class GuildModelHandler {
     ...
     * @returns
     */
    insertOne(guild: Guild, options: _OneOptions, value: string | number | boolean | GuildSchemaMemberType | GuildSchema): Promise<string | number | boolean | GuildSchema | GuildSchemaMemberType | (import("mongoose").Document<any, import("@typegoose/typegoose/lib/types").BeAnObject, any> & GuildDocument & import("@typegoose/typegoose/lib/types").IObjectWithTypegooseFunction & {
        _id: any;
    }) | undefined>;
    deleteOne(guild: Guild, options: _OneOptions): Promise<(import("mongoose").Document<any, import("@typegoose/typegoose/lib/types").BeAnObject, any> & GuildDocument & import("@typegoose/typegoose/lib/types").IObjectWithTypegooseFunction & {
        _id: any;
    })[]>;
    /**
